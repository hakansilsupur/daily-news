...
export const SOURCE_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    category: 'agency',
    language: 'zh',
    feedUrl: 'http://www.xinhuanet.com/politics/news_politics.xml',
    keywords: ['xinhua', 'çin', 'china', 'ajans'],
  },
  {
    id: 'cat:people-cn',
    name: '人民网',
    ...
    keywords: ['people daily', 'çin', 'china'],
  },
  {
    id: 'cat:global-times',
    name: 'Global Times',
  ...
  {
    id: 'cat:caixin-global',
    name: 'Caixin Global',
    region: 'cn',
    category: 'business',
    language: 'en',
    feedUrl: 'https://www.caixinglobal.com/rss/economy.xml',
    keywords: ['çin', 'china', 'ekonomi'],
  },
  ...
  },
  {
    ...
    keywords: ['hindistan', 'india', 'hindi'],
  },
  {
    id: 'cat:livemint',
    name: 'Mint',
    ...
    keywords: ['hindistan', 'india', 'ekonomi'],
  },
  ...
  },
  {
    ...
    category: 'general',
    language: 'he',
    feedUrl: 'https://www.ynet.co.il/Integration/StoryRss2.xml',
    keywords: ['israil', 'israel'],
  },
  {
    id: 'cat:israel-hayom',
    name: 'Israel Hayom',
    ...
    category: 'general',
    language: 'he',
    feedUrl: 'https://www.israelhayom.co.il/rss.xml',
    keywords: ['israil', 'israel'],
  },
  {
    id: 'cat:jerusalem-post',
  ...
  },
  {
    ...
    keywords: ['japonya', 'japan', 'ekonomi'],
  },
